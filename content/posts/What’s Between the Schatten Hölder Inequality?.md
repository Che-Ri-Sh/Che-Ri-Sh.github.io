...
|\mathrm{tr}(A^*B)|
\;\le\;
\underbrace{\|A^*B\|_{S_1}}_{=\sum_i\sigma_i(A^*B)}
\;\le\;
\sum_{i=1}^r \sigma_i(A)}^{\text{von Neumann}}\underbrace{\sigma_i(B)
\;\le\;
\|A\|_{S_p}\|B\|_{S_q}}_{\text{vector Hölder }}}_{\text{Schatten Hölder}}
.
$$
